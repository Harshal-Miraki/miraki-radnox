        ...
        <div className="container mx-auto px-6">
          <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-5">
            ...
            <div className="lg:col-span-2">
              <div className="mb-6 inline-flex items-center space-x-2 cursor-default">
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3 text-sm font-light text-zinc-400">
                  ...
                  <span>B-604, Great Eastern Summit, Sector 15, Belapur, Navi Mumbai, Maharashtra 400614</span>
                </div>
                <div className="flex items-center gap-3 text-sm font-light text-zinc-400">
                  <svg className="h-5 w-5 text-brand-teal" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                  </svg>
                  <span>sales@miraki.in</span>
                </div>
                <div className="flex items-center gap-3 text-sm font-light text-zinc-400">
                  <svg className="h-5 w-5 text-brand-teal" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                  </svg>
                  <span>+91 84011 76934</span>
                </div>
              </div>
              ...
              <div className="mt-8">
                ...
                <div className="flex gap-3">
                  {["facebook", "twitter", "instagram", "linkedin", "youtube"].map((social) => (
                    <span
                      key={social}
                      className="flex h-10 w-10 items-center justify-center rounded-full bg-zinc-800 text-zinc-400 transition-all cursor-default"
                    >
                      {social === "facebook" && (
            ...
            <div>
              ...
              <ul className="space-y-3">
                {[
                  ...
                  <li key={link.name}>
                    <span
                      className="text-sm font-light text-zinc-400 transition-colors cursor-default"
                    >
                      {link.name}
                    </span>
                  </li>
        ...
        <div className="container mx-auto px-6 py-8">
          <div className="flex flex-col items-center justify-between gap-6 md:flex-row">
            ...
            <div className="flex gap-6">
              <span className="text-sm font-light text-zinc-500 transition-colors cursor-default">
                Privacy Policy
              </span>
              <span className="text-sm font-light text-zinc-500 transition-colors cursor-default">
                Terms of Service
